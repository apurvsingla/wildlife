...
const Birds = () => {
    ...
    return (
        ...
        height:"100vh", width: '100vw', backgroundSize: 'cover', filter: 'blur(2px)', top: '0'}}
        />
        
        <MultiCards>
            <button style={{position: 'fixed', right: '0', top: '0', cursor: 'pointer', padding: '5px', fontSize: '1.2rem'}} 
